...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO holiday (holiday_name, start_date, end_date, days, year) 
            VALUES ('$holiday_name', '$start_date', '$end_date', '$days', '$year')";
        ...
        <div class="add_holiday-container">
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="holiday" name="holiday_name" placeholder="Enter holiday name" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="day" name="days" placeholder="Enter How many days" readonly>
                </div>
