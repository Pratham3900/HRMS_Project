    ...
    <div class="add_holiday-container">
      <form method="post" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" id="notice_title" name="title" value="<?php echo $title; ?>">
        </div>
        <div class="form-group">
          <label for="notice_description">Notice Description</label>
          <input type="text" id="notice_description" name="description" value="<?php echo $description; ?>">
        </div>
    
       
        <div class="form-group">
          <label for="Publish_date">Publish Date</label>
          <input type="date" id="Publish_date" name="date" value="<?php echo $date; ?>">
        </div>
        <div class="form-group">
